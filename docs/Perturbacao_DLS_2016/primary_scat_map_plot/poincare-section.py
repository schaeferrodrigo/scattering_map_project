...
#===============================================================================
# Rmarks: I'm using the same script of "scattering_map_fuction", but now, I'm
# defining a Poincaré section on the variables (I_2 , theta_2) theta_2 = pi

def SM_PS( iv_I_1 , iv_I_2 , iv_theta_1 , iv_theta_2 , n_steps = 0):
    ...
    while n_steps < max_steps and  any(resonances_test) == False:
        ...
        if np.abs( theta[1] - np.pi) < 1e-2: #Poincaré section
