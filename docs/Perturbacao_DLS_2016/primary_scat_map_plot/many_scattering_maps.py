...
#===============================================================================
def many_scattering_maps( domain_I_1 , domain_I_2 , domain_theta_1 , domain_theta_2  ):
        ...
        for init_I_2 in domain_I_2:
            for init_theta_1 in domain_theta_1:
                for in_theta_2 in domain_theta_2:
                    ...
                    I_1_values , I_2_values , theta_1_values , theta_2_values = SM(init_I_1 , init_I_2, init_theta_1 , in_theta_2 )
